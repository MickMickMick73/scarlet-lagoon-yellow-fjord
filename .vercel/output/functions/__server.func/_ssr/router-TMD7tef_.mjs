...
import { t as __exportAll$1 } from "./ssr.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-TMD7tef_.js
var router_TMD7tef__exports = /* @__PURE__ */ __exportAll({
	a: () => getBaseURL,
	getRouter: () => getRouter,
	i: () => PACKAGE_VERSION,
	n: () => GROK_PROVIDERS,
	r: () => GENERIC_OAUTH_ERROR_CODES,
	t: () => router_exports
});
...
var styles_default = "/assets/styles-Cc7k9VCs.css";
var APP_NAME = "Nighthaul";
var Route$5 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A cyberpunk space-trader. Inherit a wrecked hauler, walk rain cities, trade, fight, and wake a frozen colony."
			},
			{
			...
			},
			{
				...
				content: "Inherit the wreck. Wake the colony."
			},
			...[],
			...[]
		],
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Syne:wght@500;600;700&family=IBM+Plex+Sans:wght@400;500;600&family=IBM+Plex+Mono:wght@400;500&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter$3 = () => import("./routes-DLaS33Zp.mjs");
var Route$4 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./kit-DlhlNBeP.mjs");
var Route$3 = createFileRoute("/kit")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./login-DNswZjJn.mjs");
var Route$2 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./play-3DSUtrzK.mjs");
...
//#endregion
export { router_TMD7tef__exports as a, getBaseURL as i, GROK_PROVIDERS as n, PACKAGE_VERSION as r, GENERIC_OAUTH_ERROR_CODES as t };
